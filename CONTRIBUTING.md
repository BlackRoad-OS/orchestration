...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/orchestration.git
cd orchestration

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/orchestration.git
